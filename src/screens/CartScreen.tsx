...
import { Delete, Send, CreditCard, User, Sliders } from 'lucide-react-native';
...
export function CartScreen({ navigation }: NativeStackScreenProps<RootStackParamList, 'Cart'>) {
    ...
    const actions = () => {
        if (!selected) return;
        Alert.alert('Actions', selected.name_snapshot, [
            { text: 'Retirer l\'article', style: 'destructive', onPress: () => setLineQty(selected.id, 0) },
    ...
    return (
        <Screen style={{ padding: 0 }} edges={['bottom']}>
            ...
            <View style={styles.secondaryRow}>
                ...
                <Pressable style={styles.secondaryBtn} onPress={actions}>
